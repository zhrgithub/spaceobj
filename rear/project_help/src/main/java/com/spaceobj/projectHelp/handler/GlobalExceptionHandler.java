package com.spaceobj.projectHelp.handler;
...
public class GlobalExceptionHandler {
  ...
  public SaResult httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
    return SaResult.error("请求类型错误");
  }
