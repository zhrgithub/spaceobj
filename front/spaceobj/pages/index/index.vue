<template>
	<view class="space-obj-background-style" :style="{background: 'url('+bgImage+')'}">
		...
		<view class="terminal-background-style">
			...
			<view class="body-style">
				...
				<view class="root-style">
					zhr@zhrdeMacBook-Pro ~ %  <text style="color: black;margin-left: 10rpx;font-weight: bold;">./weather.sh</text>
				</view>
		...
		<view class="filing-background-style">
			...
			<uni-link href="https://beian.miit.gov.cn/" text="© 冀ICP备2020029498号-2" color="#FFF" font-size="16"></uni-link>
		</view>
