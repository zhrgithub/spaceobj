	...
	<view class="release-background-style">
		...
		<view class="search-background-style">
			<view class="search-logo-background-style">
				...
				<view class="input-background-style">
					<input :value="seachText" type="text" maxlength="15" placeholder="元宇宙、商城、聊天、APP、网站" placeholder-style="font-size:14px" confirm-type="search" @confirm="doSearch" @input="inputText">
		...
		<uni-popup ref="popup" background-color="#fff">
			...
			<view class="description-doller-style">
				...
				<view class="description-style">
					<textarea maxlength="1000" name="needDescription" id="" cols="30" rows="100" placeholder="请输入您的需求信息"></textarea>
				</view>
		...
		<view class="shop-list-style">
			<swiper class="swiper" @change="getItem" :current = "act" autoplay="true" interval="3000" circular="true">
				...
				<swiper-item>
					<view class="swiper-item uni-bg-blue">E</view>
				</swiper-item> -->
	...
	export default {
		data() {
			return {
				...
				//数据索引
				currentIndex:0,
				shopList:[{id:0,name:"测试"},{id:0,name:"测试"},{id:0,name:"测试"}],
			}
		},
		methods: {
			showMoreUser(type) {
