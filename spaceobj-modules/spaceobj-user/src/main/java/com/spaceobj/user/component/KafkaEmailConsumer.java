...
import com.spaceobj.common.core.dto.Email;
import com.spaceobj.common.core.utils.CommonStringUtils;
import com.spaceobj.common.core.utils.ExceptionUtil;
import com.spaceobj.common.core.utils.SendMail;
...
public class KafkaEmailConsumer {
    ...
    private void sendEmail(Object message) {
        ...
        if (StringUtils.isBlank(sysEmail.getEmailAccount()) || StringUtils.isBlank(CommonStringUtils.getEmailAccountName(sysEmail.getEmailAccount())) || StringUtils.isBlank(sysEmail.getEmailPassword())) {
        ...
        if (StringUtils.isBlank(email.getReceiverEmail()) || StringUtils.isBlank(email.getContent()) || StringUtils.isBlank(email.getTitle())) {
            log.error("邮件发送参数错误！停止发送！");
