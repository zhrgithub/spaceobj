...
@Data
@Builder
public class JdAdvertiseDto implements Serializable {

    @NotNull(message = "广告id不为空",
            groups = {DeleteAdvertiseGroup.class, UpdateAdvertiseGroup.class})
    private Integer jdAdId;

    @NotBlank(message = "广告超链接不为空",
            groups = {InsertAdverTiseGroup.class, UpdateAdvertiseGroup.class})
    private String jdAdHyperlink;

    @NotBlank(message = "图片超链接不为空",
            groups = {InsertAdverTiseGroup.class, UpdateAdvertiseGroup.class})
    private String jdAdImageLink;

    @NotBlank(message = "广告名称不为空",
            groups = {InsertAdverTiseGroup.class, UpdateAdvertiseGroup.class})
    private String jdAdName;

    @NotBlank(message = "店铺名不为空",
            groups = {InsertAdverTiseGroup.class, UpdateAdvertiseGroup.class})
    private String jdAdStoreName;

    @NotBlank(message = "优惠券描述不为空",
            groups = {InsertAdverTiseGroup.class, UpdateAdvertiseGroup.class})
